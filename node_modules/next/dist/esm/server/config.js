...
function assignDefaults(dir, userConfig) {
    ...
    if (result.experimental && "allowMiddlewareResponseBody" in result.experimental) {
        Log.warn(`\`allowMiddlewareResponseBody\` has been moved out of \`experimental\`. Please update your ${configFileName} file accordingly.`);
        result.allowMiddlewareResponseBody = result.experimental.allowMiddlewareResponseBody;
    }
